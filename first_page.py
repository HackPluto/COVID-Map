...
# 设置全局配置项
#map_.set_global_opts(title_opts=opts.TitleOpts(title="国外疫情情况"),  # 设置图标题visualmap_opts=opts.VisualMapOpts(max_=1000000, is_piecewise=True))  # 显示图例

map_.set_global_opts(title_opts=opts.TitleOpts(title="国外疫情情况"),  # 设置图标题
                      visualmap_opts=opts.VisualMapOpts(pieces=[  # 自定义分组的分店和颜色
                              {"min": 900000, "color": "#C1121C"},
                              {"min": 50000, "max": 500000, "lable":'0.15~0.19', "color": "#D3545F"},
                         {"min": 10000, "max": 50000, "color": "#3481B8"},
                            {"min": 1000, "max": 10000, "color": "#EEC900"},
                             {"min": 0, "max": 1000, "color": "#EAF044"},
                              {"max": 0, "color": "#F4F8F4"},
                      ],is_piecewise=True))  # 显示分段式图例


map_.render("first_page.html")